...
FROM _sp p, _su u WHERE u.username = 'pm_li';
...
FROM _sp p, _su u WHERE u.username = 'engineer_zhang';
...
FROM _sp p, _su u WHERE u.username = 'supervisor_chen';
...
FROM _sp p, _su u WHERE u.username = 'site_foreman_liu';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'designer_zhao' AND u2.username = 'pm_li';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'pm_li' AND u2.username = 'admin_wang';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'engineer_zhang' AND u2.username = 'pm_li';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'supervisor_chen' AND u2.username = 'pm_li';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'site_foreman_liu' AND u2.username = 'engineer_zhang';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'engineer_zhang' AND u2.username = 'supervisor_chen';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'pm_li' AND u2.username = 'engineer_zhang';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'landscape_huang' AND u2.username = 'engineer_zhang';
...
SELECT uuid_generate_v4()::text, 'MTG-20251215-0001', p.id,
    ...
    '["admin_wang","pm_li","engineer_zhang","supervisor_chen","designer_zhao"]', NULL,
...
SELECT uuid_generate_v4()::text, 'MTG-20260110-0001', p.id,
    ...
    '["engineer_zhang","supervisor_chen","worker_sun","site_foreman_liu"]', NULL,
...
SELECT uuid_generate_v4()::text, 'MTG-20260705-0001', p.id,
    ...
    '["supervisor_chen","engineer_zhang","site_foreman_liu","designer_zhao"]', NULL,
...
SELECT uuid_generate_v4()::text, 'MTG-20260712-0001', p.id,
    ...
    '["pm_li","engineer_zhang","landscape_huang","site_foreman_liu","supervisor_chen"]', NULL,
...
FROM _sp p, _su u WHERE u.username = 'designer_zhao';
...
FROM _sp p, _su u WHERE u.username = 'landscape_huang';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'pm_li' AND u2.username = 'pm_li';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'supervisor_chen' AND u2.username = 'supervisor_chen';
...
FROM _splan pl, _su u1, _su u2 WHERE u1.username = 'engineer_zhang' AND u2.username = 'pm_li';
...
FROM _splan pl, _su u1, _su u2 WHERE u1.username = 'designer_zhao' AND u2.username = 'pm_li';
...
FROM _splan pl, _su u1, _su u2 WHERE u1.username = 'engineer_zhang' AND u2.username = 'supervisor_chen';
...
FROM _splan pl, _su u1, _su u2 WHERE u1.username = 'site_foreman_liu' AND u2.username = 'engineer_zhang';
...
FROM _splan pl, _su u1, _su u2 WHERE u1.username = 'landscape_huang' AND u2.username = 'engineer_zhang';
...
SELECT uuid_generate_v4()::text, pl.id, 18, '竣工验收与备案',
    ...
    u2.id, '2025-12-15T08:00:00', '2026-07-13T12:00:00', false
FROM _splan pl, _su u1, _su u2 WHERE u1.username = 'pm_li' AND u2.username = 'admin_wang';
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    ...
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(1), c.id, u.id, 'sim_pm_li',
    '张工，场地平整进度如何？明天能完成吗？',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-09T10:00:00'
FROM _sconv_work c, _su u WHERE u.username = 'pm_li';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(2), c.id, u.id, 'sim_site_foreman_liu',
    '李经理，场地平整今天下午就能完成，压实度检测正在进行。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-09T10:05:00'
FROM _sconv_work c, _su u WHERE u.username = 'site_foreman_liu';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(3), c.id, u.id, 'sim_pm_li',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(4), c.id, u.id, 'sim_landscape_huang',
    'EMERALD-01项目场地平整完成了，帮我更新进度',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-10T15:30:00'
FROM _sconv_work c, _su u WHERE u.username = 'landscape_huang';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(5), c.id, u.id, 'sim_engineer_zhang',
    '收到，景观方案已经发给李经理了，等待审核。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-10T15:32:00'
FROM _sconv_work c, _su u WHERE u.username = 'engineer_zhang';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(6), c.id, u.id, 'sim_pm_li',
    '好的，我尽快审核。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-10T15:35:00'
FROM _sconv_work c, _su u WHERE u.username = 'pm_li';
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(7), c.id, u.id, 'sim_supervisor_chen',
    '场地平整已验收，压实度0.94，符合要求。可以移交给景观班组。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-10T16:00:00'
FROM _sconv_work c, _su u WHERE u.username = 'supervisor_chen';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(8), c.id, u.id, 'sim_site_foreman_liu',
    '收到，明天开始场地移交。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-10T16:02:00'
FROM _sconv_work c, _su u WHERE u.username = 'site_foreman_liu';
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(9), c.id, u.id, 'sim_pm_li',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(10), c.id, u.id, 'sim_landscape_huang',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(11), c.id, u.id, 'sim_supervisor_chen',
    '苗木进场报验单已经审核通过。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-11T14:00:00'
FROM _sconv_work c, _su u WHERE u.username = 'supervisor_chen';
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(12), c.id, u.id, 'sim_pm_li',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(13), c.id, u.id, 'sim_engineer_zhang',
    '进度款申请已经提交了，请各位领导审批。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-12T08:30:00'
FROM _sconv_work c, _su u WHERE u.username = 'engineer_zhang';
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(14), c.id, u.id, 'sim_admin_wang',
    '收到，财务这边会尽快处理。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-12T08:35:00'
FROM _sconv_work c, _su u WHERE u.username = 'admin_wang';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(15), c.id, u.id, 'sim_landscape_huang',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(16), c.id, u.id, 'sim_engineer_zhang',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(17), c.id, u.id, 'sim_designer_zhao',
    '景观方案我看过了，绿化品种和布局都符合设计要求。',
    'inbound', 'text', 0, '[]', '', NULL, 'sim_emer_work',
    '2026-07-12T10:15:00'
FROM _sconv_work c, _su u WHERE u.username = 'designer_zhao';

-- 8.2 Private chat messages (李景利↔张正宏)
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(18), c.id, u.id, 'sim_pm_li',
    '张工，3#楼外立面色差整改进展如何？',
    'inbound', 'text', 0, '[]', '', NULL, NULL,
    '2026-07-08T09:00:00'
FROM _sconv_li_zhang c, _su u WHERE u.username = 'pm_li';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(19), c.id, u.id, 'sim_engineer_zhang',
    '李经理，已经整改完成，监理昨天已经复验通过了。',
    'inbound', 'text', 0, '[]', '', NULL, NULL,
    '2026-07-08T09:05:00'
FROM _sconv_li_zhang c, _su u WHERE u.username = 'engineer_zhang';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(20), c.id, u.id, 'sim_pm_li',
    '好的，那这件事就闭环了。辛苦了。',
    'inbound', 'text', 0, '[]', '', NULL, NULL,
    '2026-07-08T09:10:00'
FROM _sconv_li_zhang c, _su u WHERE u.username = 'pm_li';
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(21), c.id, u.id, 'sim_engineer_zhang',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(22), c.id, u.id, 'sim_pm_li',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(23), c.id, u.id, 'sim_supervisor_chen',
    '3#楼外立面整改已完成，请各位确认。',
    'inbound', 'text', 0, '[]', '', NULL, NULL,
    '2026-07-10T14:00:00'
FROM _sconv_quality c, _su u WHERE u.username = 'supervisor_chen';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(24), c.id, u.id, 'sim_engineer_zhang',
    '已确认，整改区域真石漆颜色与周边一致。',
    'inbound', 'text', 0, '[]', '', NULL, NULL,
    '2026-07-10T14:10:00'
FROM _sconv_quality c, _su u WHERE u.username = 'engineer_zhang';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(25), c.id, u.id, 'sim_designer_zhao',
    '确认，满足设计要求。',
    'inbound', 'text', 0, '[]', '', NULL, NULL,
    '2026-07-10T14:15:00'
FROM _sconv_quality c, _su u WHERE u.username = 'designer_zhao';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(26), c.id, u.id, 'sim_supervisor_chen',

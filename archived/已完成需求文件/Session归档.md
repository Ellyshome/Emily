...
> ⚠️ **V1 已弃用（2026-07-23）**：本方案采用"整轮完成后一次性渲染"模式，存在排序人为选择、
> 意图识别缺位、call_category 全标 intent、Prompt 注入过程不可见四个根因问题。
> 当前已升级为 **V2：Hook 逐段追加**，见 [Session归档V2-钩子逐段追加.md](Session归档V2-钩子逐段追加.md)。
> 本文档保留作历史参考，新代码请遵循 V2。
...
> Session Prompt: session.md (模板 2847 字，变量见快照)
...
- user_id: 550e8400-...
- 职位: 参建执行 · 部门: 工程部
- 企业: 中天建设集团 / 总承包 / id=CT-001
- 权限: level 2（非管理单位）

**可见范围**
- 授权节点: SG-JG-01、SG-JG-02
- scopes: project:ECOCITY-26
- 可见项目: ECOCITY-26
- info_level: public
- sop_allow: query_current_node、create_event、...
- 权限版本: v3 @ 2026-07-22 10:00:00
...
- 技能 10 · 工具 6 · 可见文件 47
- 知识库: 可用（默认知识库）
- 项目世界书 3421 字 · 规则书 1892 字 · 系统自我描述 560 字

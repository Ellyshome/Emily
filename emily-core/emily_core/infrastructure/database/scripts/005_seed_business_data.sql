...
FROM _sp p, _su u1 WHERE u1.username = 'engineer_zhang';
...
FROM _sp p, _su u1 WHERE u1.username = 'supervisor_chen';
...
FROM _sp p, _su u1 WHERE u1.username = 'designer_zhao';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'worker_sun' AND u2.username = 'engineer_zhang';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'worker_sun' AND u2.username = 'pm_li';
...
SELECT uuid_generate_v4()::text, 'MTG-20260201-0001', p.id,
    ...
    '["pm_li", "engineer_zhang", "supervisor_chen", "designer_zhao"]', NULL,
...
SELECT uuid_generate_v4()::text, 'MTG-20260215-0001', p.id,
    ...
    '["pm_li", "engineer_zhang", "supervisor_chen", "designer_zhao", "admin_wang"]', NULL,
...
SELECT uuid_generate_v4()::text, 'MTG-20260316-0001', p.id,
    ...
    '["pm_li", "engineer_zhang", "supervisor_chen", "worker_sun"]', NULL,
...
SELECT uuid_generate_v4()::text, 'MTG-20260704-0001', p.id,
    ...
    '["admin_wang", "pm_li", "engineer_zhang", "supervisor_chen", "worker_sun"]', NULL,
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'engineer_zhang' AND u2.username = 'designer_zhao';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'supervisor_chen' AND u2.username = 'worker_sun';
...
FROM _sp p, _su u1, _su u2 WHERE u1.username = 'supervisor_chen' AND u2.username = 'engineer_zhang';
...
SELECT uuid_generate_v4()::text, pl.id, 5, '地基与基础分部验收',
    ...
    '一次性通过',
    u2.id, '2026-01-15T08:00:00', '2026-01-31T17:00:00', false
FROM _splan pl, _su u1, _su u2 WHERE u1.username = 'supervisor_chen' AND u2.username = 'pm_li';
...
INSERT INTO conversations (id, im_platform, conversation_type, conversation_id, group_id,
    title, project_id, takeover_mode, created_at, updated_at)
SELECT uuid_generate_v4()::text, 'simulator', 'private', 'private_pm_li', NULL,
    '李经理私聊', p.id, 'auto',
    '2026-01-15T08:00:00', '2026-07-13T12:00:00'
FROM _sp p;

CREATE TEMP TABLE _sconv_pm AS
SELECT id FROM conversations WHERE conversation_id = 'private_pm_li' LIMIT 1;

INSERT INTO conversations (id, im_platform, conversation_type, conversation_id, group_id,
    title, project_id, takeover_mode, created_at, updated_at)
SELECT uuid_generate_v4()::text, 'simulator', 'private', 'private_engineer_zhang', NULL,
    '张工私聊', p.id, 'auto',
    '2026-01-15T08:00:00', '2026-07-13T12:00:00'
FROM _sp p;
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    ...
    created_at)
SELECT uuid_generate_v4()::text, _seed_event_id(1), c.id, u.id, 'sim_admin_wang',
    '各位好，生态城一期项目工作群正式启用。以后日常工作沟通、进度汇报、验收通知都在群里进行。请各单位主要人员确认收到。',
    'inbound', 'text', 0, '[]', '', NULL, 'ECOCITY26_WORK',
    '2026-01-15T09:00:00'
FROM _sconv_group c, _su u WHERE u.username = 'admin_wang';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(2), c.id, u.id, 'sim_pm_li',
    '收到。王总。工程部全员已入群。',
    'inbound', 'text', 0, '[]', '', NULL, 'ECOCITY26_WORK',
    '2026-01-15T09:02:00', '2026-01-15T09:02:00'
FROM _sconv_group c, _su u WHERE u.username = 'pm_li';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(3), c.id, u.id, 'sim_engineer_zhang',
    '收到。总包项目部已全员入群。',
    'inbound', 'text', 0, '[]', '', NULL, 'ECOCITY26_WORK',
    '2026-01-15T09:03:00', '2026-01-15T09:03:00'
FROM _sconv_group c, _su u WHERE u.username = 'engineer_zhang';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(4), c.id, u.id, 'sim_supervisor_chen',
    '收到。监理部已入群。',
    'inbound', 'text', 0, '[]', '', NULL, 'ECOCITY26_WORK',
    '2026-01-15T09:04:00', '2026-01-15T09:04:00'
FROM _sconv_group c, _su u WHERE u.username = 'supervisor_chen';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(5), c.id, u.id, 'sim_pm_li',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(7), c.id, u.id, 'sim_engineer_zhang',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(8), c.id, u.id, 'sim_engineer_zhang',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(9), c.id, u.id, 'sim_supervisor_chen',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(10), c.id, u.id, 'sim_pm_li',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(11), c.id, u.id, 'sim_designer_zhao',
    '@Emily 结构设计变更——3层部分框架梁截面需要调整，请帮我发起一个变更审批流程。',
    'inbound', 'text', 0, '[]', '', NULL, 'ECOCITY26_WORK',
    '2026-06-10T09:30:00', '2026-06-10T09:30:00'
FROM _sconv_group c, _su u WHERE u.username = 'designer_zhao';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(12), c.id, u.id, 'sim_engineer_zhang',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(13), c.id, u.id, 'sim_pm_li',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(14), c.id, u.id, 'sim_worker_sun',
    '李经理，钢筋进场报验已经提交系统了，HRB400E约180吨，质保书齐全。请监理安排验收。',
    'inbound', 'text', 0, '[]', '', NULL, 'ECOCITY26_WORK',
    '2026-07-08T08:45:00', '2026-07-08T08:45:00'
FROM _sconv_group c, _su u WHERE u.username = 'worker_sun';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(15), c.id, u.id, 'sim_supervisor_chen',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(16), c.id, u.id, 'sim_pm_li',
...
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(17), c.id, u.id, 'sim_engineer_zhang',
    '@Emily 帮我查一下我这周有哪些待办任务。',
    'inbound', 'text', 0, '[]', '', NULL, 'ECOCITY26_WORK',
    '2026-07-13T08:30:00', '2026-07-13T08:30:00'
FROM _sconv_group c, _su u WHERE u.username = 'engineer_zhang';

-- 8.2 Private chat messages (pm_li with emily)
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
...
FROM _sconv_pm c, _su u WHERE u.username = 'pm_li';

INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(19), c.id, u.id, 'sim_pm_li',
    '@Emily 帮我把项目质量管理制度文件发给总包张工和监理陈工。',
    'inbound', 'text', 0, '[]', '', NULL, NULL,
    '2026-07-11T09:00:00', '2026-07-11T09:00:00'
FROM _sconv_pm c, _su u WHERE u.username = 'pm_li';

-- 8.3 Private chat messages (worker_sun with emily)
INSERT INTO messages (id, event_id, conversation_id, sender_user_id, sender_im_id, content,
    direction, message_type, msg_type, attachments, file_url, receiver_id, group_id,
    created_at, updated_at)
SELECT uuid_generate_v4()::text, _seed_event_id(20), c.id, u.id, 'sim_worker_sun',
    '@Emily 我的防暑降温任务已经完成了，饮水点和药品都配好了，帮我标记一下完成。',
    'inbound', 'text', 0, '[]', '', NULL, NULL,
    '2026-07-12T10:00:00', '2026-07-12T10:00:00'
FROM _sconv_pm c, _su u WHERE u.username = 'worker_sun';
